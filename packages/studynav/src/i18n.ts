export const EN_MESSAGES = {
  ...
  extension_mobile_description: 'Unofficial local highlights, notes, saved places, and sharing tools for public JW.org pages in Microsoft Edge Mobile. No telemetry or uploads; not affiliated with Jehovah’s Witnesses.',
  ...
  popup_mobile_header_subtitle: 'For Edge on phones · data stays on this device',
  tools: 'Tools',
  ...
  status_media_mobile_hint: 'Media downloads and player controls are not included on phones.',
