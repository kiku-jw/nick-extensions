export const EN_MESSAGES = {
  ...
  extension_mobile_description: 'Unofficial local highlights, notes, saved places, and exact links for public JW.org pages in Edge on Android. No telemetry.',
  ...
  popup_mobile_header_subtitle: 'For Edge on Android · data stays on this device',
  tools: 'Tools',
  ...
  status_media_mobile_hint: 'Media downloads and player controls are not included in the Android package.',
