...
- Target about 130 words per minute.
...
**Voice-over:** With StudyNav, you can write notes on JW.org, share links to selected verses, download the part you need, and control videos from the keyboard.
...
**Voice-over:** Highlight words in one of six colors. Add a note or tags, and keep the note beside the text when space allows.
...
**Voice-over:** Press Save place beside a paragraph or verse. Later, open your saved places and return there with one click.
...
**Voice-over:** Select the text and press Copy quote. Its publication title and link are copied too, ready to send.
...
**Voice-over:** Press QR code and scan it with your phone. The page or selected verse opens there.
...
**Voice-over:** If the page address is long, press Open clean link. StudyNav opens a shorter JW.org address for the same publication.
...
**Voice-over:** Click the verse number. For several verses in a row, choose the first and last, then press Download audio to save one audio file.
...
**Voice-over:** When you paste the verse, you get only words, without the number, reference letters, footnotes, or extension buttons.

**Edit:** Copy a verse and compare the page text with the clean clipboard result beside it.

## 08 — One link for several verses

**Voice-over:** Choose the first and last verse, then press Link. One link is copied for all selected verses.
...
**Voice-over:** Know a publication code or document number? Press Control or Command plus Shift and K, enter the code, and StudyNav finds it with the regular JW.org and WOL search. This is not an AI search.

**Edit:** Press the shortcut, enter a short code, and show the JW.org and WOL results.

## 10 — Show an image description

**Voice-over:** Press Description below an image to read the caption and explanation provided by the website.
...
**Voice-over:** Turn on image downloads. A Download image button appears below pictures in articles.
...
**Voice-over:** The number beside the language button shows how many translations this page has.
...
**Voice-over:** Turn this on, and the title and buttons stay at the top while you read.
...
**Voice-over:** On a wide screen, widen the article. Lines hold more words, while notes and windows keep their size.

**Edit:** Show the original width, turn the setting on, and smoothly expand only the article column.

## 15 — Separate table rows

**Voice-over:** StudyNav separates table rows with spacing and different backgrounds, making them easier to follow.
...
**Voice-over:** Hover over a video. Its controls appear, but the picture no longer darkens at the edges.
...
**Voice-over:** Captions become larger and clearer, making them easier to read.

**Edit:** Show the same caption line before and after the setting is enabled.

## 18 — Control the player from the keyboard

**Voice-over:** Press Space or K to pause and continue. J and L move through the video, M turns off sound, and F opens full screen.
...
**Voice-over:** Pause where you want and press Copy page plus time. When pasted, it shows the page link and the time to seek to. The video will not start at that time automatically.

**Edit:** Pause at 2:14, press the button, and show the copied address together with “Time: 2:14.”

## 20 — Download a segment by time

**Voice-over:** Enter the start and end. StudyNav downloads only that part: up to two minutes of audio or one minute of video.
...
**Voice-over:** StudyNav remembers where you stopped. When you return, press Resume at… to go there again without starting the video automatically.
...
**Voice-over:** Press Second display to open the video or audio in a small separate window. The media file is not downloaded.
...
**Voice-over:** If captions or text come with the video, StudyNav shows a button to search and download them. Without text, there is no button.

**Edit:** First show media with the button and available text, then media without captions where the button is absent.

## 24 — Outro

**Voice-over:** Download the StudyNav archive and unzip it. Then open the extensions page in Chrome and press Load unpacked.
