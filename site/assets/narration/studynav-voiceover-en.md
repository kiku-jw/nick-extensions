...
- Use the same ElevenLabs voice and settings that produced the 3:50 English
  test. This longer script is calibrated to finish at about 4:30.
...
**Voice-over:** With StudyNav, you can write notes on JW.org, share links to selected verses, download only the audio or video part you need, and control videos directly from the keyboard.
...
**Voice-over:** Highlight words in one of six colors. Add a note or useful tags, and keep the note beside the text when the window has enough space.
...
**Voice-over:** Press Save place beside a paragraph or verse. Later, open your saved places and return to the exact spot with one click.
...
**Voice-over:** Select the text and press Copy quote. Its publication title and link are copied too, so the result is ready to send.
...
**Voice-over:** Press QR code and scan it with your phone. The page or selected verse then opens on your screen.
...
**Voice-over:** If the page address is long, press Open clean link. StudyNav opens a shorter address for the same publication on JW.org instead.
...
**Voice-over:** Click the verse number. To save several verses in a row, choose the first and last. Then press Download audio, and StudyNav saves all those verses as one audio file.
...
**Voice-over:** When you paste the copied verse, only the actual words remain: no number, small reference letters, footnotes, or extension buttons.

**Edit:** Copy a verse and compare the page text with the clean clipboard result beside it.

## 08 — One link for several verses

**Voice-over:** Choose the first and last verse, then press Link. StudyNav copies one link that opens all the verses you selected together.
...
**Voice-over:** Know a publication code or document number? Press Control or Command plus Shift and K, enter the code, and StudyNav finds it with the regular JW.org and WOL search, without making you browse through menus. This is not an AI search.

**Edit:** Press the shortcut, enter a short code, and show the JW.org and WOL results.

## 10 — Show an image description

**Voice-over:** Press Description below an image to read its caption and the explanation provided for that picture on the website.
...
**Voice-over:** Turn on image downloads. A clear Download image button then appears below pictures in articles.
...
**Voice-over:** The number beside the language button shows how many translations are available for the page.
...
**Voice-over:** Turn this on, and the title and buttons stay at the top as you keep reading.
...
**Voice-over:** On a wide screen, widen the article. Each line holds more words, while notes, menus, and other windows keep their normal size.

**Edit:** Show the original width, turn the setting on, and smoothly expand only the article column.

## 15 — Separate table rows

**Voice-over:** StudyNav separates table rows with spacing and different backgrounds, making long or crowded tables easier to follow.
...
**Voice-over:** Hover over a video. Its controls still appear, but the picture no longer becomes darker around the edges.
...
**Voice-over:** Captions become larger and clearer on screen, making them easier to read.

**Edit:** Show the same caption line before and after the setting is enabled.

## 18 — Control the player from the keyboard

**Voice-over:** Press Space or K to pause and continue the video. Use J and L to move backward or forward, M to turn off sound, and F to open full screen.
...
**Voice-over:** Pause where you want and press Copy page plus time. When you paste the result, it shows the page link and the exact time to seek to. The video itself will not start at that time automatically.

**Edit:** Pause at 2:14, press the button, and show the copied address together with “Time: 2:14.”

## 20 — Download a segment by time

**Voice-over:** Enter the start and end. StudyNav downloads only that part of the recording: up to two minutes of audio or one minute of video.
...
**Voice-over:** StudyNav remembers where you stopped watching. When you return, press Resume at… to go back there without starting the video until you are ready.
...
**Voice-over:** Press Second display to open the video or audio in a separate window beside the page. The media file itself is not downloaded.
...
**Voice-over:** If captions or text come with the video, StudyNav shows a button to search through the words and download them. If no text is available, the button does not appear.

**Edit:** First show media with the button and available text, then media without captions where the button is absent.

## 24 — Outro

**Voice-over:** Download the StudyNav archive and unzip it first. Then open the extensions page in Chrome and press the Load unpacked button.
